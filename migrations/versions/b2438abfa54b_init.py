...
def upgrade() -> None:
    ...
    op.alter_column(
        "chat_message", "session_uuid", existing_type=sa.UUID(), nullable=False
    )
    op.drop_constraint("chat_session_uuid_fkey", "chat_message", type_="foreignkey")
    op.create_foreign_key(
        None, "chat_message", "chat_session", ["session_uuid"], ["uuid"]
    )
    ...
    op.alter_column(
        "chat_session", "version_uuid", existing_type=sa.UUID(), nullable=False
    )
    op.drop_constraint(
        "chat_session_version_uuid_fkey", "chat_session", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "chat_session", "chat_model_version", ["version_uuid"], ["uuid"]
    )
    op.drop_column("chat_session", "metadata")
    ...
    op.create_foreign_key(
        None, "prompt", "function_model_version", ["version_uuid"], ["uuid"]
    )
    op.alter_column(
        "function_model", "project_uuid", existing_type=sa.UUID(), nullable=False
    )
    op.drop_constraint(
        "function_model_project_uuid_fkey", "function_model", type_="foreignkey"
    )
    op.create_foreign_key(None, "function_model", "project", ["project_uuid"], ["uuid"])
    op.alter_column(
    ...
    op.drop_constraint(
        "function_model_version_function_model_uuid_fkey",
        "function_model_version",
        type_="foreignkey",
    )
    op.drop_constraint(
        "function_model_version_parsing_type_fkey",
        "function_model_version",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key(
        None, "run_log", "function_model_version", ["version_uuid"], ["uuid"]
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "function_model", "project_uuid", existing_type=sa.UUID(), nullable=True
    )
    ...
    op.alter_column(
        "chat_session", "version_uuid", existing_type=sa.UUID(), nullable=True
    )
    op.alter_column(
        "chat_session",
        "run_from_deployment",
    ...
    op.drop_column("chat_session", "session_metadata")
    op.add_column(
        "chat_message",
        sa.Column(
            "metadata",
    ...
    op.alter_column(
        "chat_message", "session_uuid", existing_type=sa.UUID(), nullable=True
    )
    op.drop_column("chat_message", "chat_message_metadata")
    # ### end Alembic commands ###
