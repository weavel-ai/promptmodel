  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["version_uuid"]
            isOneToOne: false
            referencedRelation: "deployed_prompt_model_version"
            referencedColumns: ["uuid"]
          },
          {
            foreignKeyName: "prompt_version_uuid_fkey"
            ...
            referencedColumns: ["prompt_model_version_uuid"]
          },
          {
            foreignKeyName: "prompt_version_uuid_fkey"
            columns: ["version_uuid"]
            isOneToOne: false
            referencedRelation: "prompt_model_version"
            referencedColumns: ["uuid"]
          }
        ]
      }
      prompt_model: {
        ...
        Relationships: [
          {
            foreignKeyName: "prompt_model_dev_branch_uuid_fkey"
            columns: ["dev_branch_uuid"]
            isOneToOne: false
            referencedRelation: "dev_branch"
            referencedColumns: ["uuid"]
          ...
          {
            foreignKeyName: "prompt_model_project_uuid_fkey"
            columns: ["project_uuid"]
            isOneToOne: false
            referencedRelation: "daily_project_run_log_metric"
            referencedColumns: ["project_uuid"]
      ...
      prompt_model_version: {
        ...
        Relationships: [
          {
            foreignKeyName: "prompt_model_version_dev_branch_uuid_fkey"
            columns: ["dev_branch_uuid"]
            isOneToOne: false
            referencedRelation: "dev_branch"
            referencedColumns: ["uuid"]
          ...
          {
            foreignKeyName: "prompt_model_version_parsing_type_fkey"
          ...
          {
            foreignKeyName: "prompt_model_version_prompt_model_uuid_fkey"
            columns: ["prompt_model_uuid"]
            isOneToOne: false
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "deployment_run_log_view"
            referencedColumns: ["prompt_model_uuid"]
          },
          {
            foreignKeyName: "prompt_model_version_prompt_model_uuid_fkey"
            columns: ["prompt_model_uuid"]
            isOneToOne: false
            referencedRelation: "prompt_model"
            referencedColumns: ["uuid"]
          }
        ]
      }
    ...
    Views: {
      ...
      deployment_run_log_view: {
        Row: {
          ...
          prompt_model_uuid: string | null
          prompt_model_version: number | null
          prompt_model_version_uuid: string | null
          raw_output: string | null
          run_from_deployment: boolean | null
          score: number | null
          token_usage: Json | null
